...
function drawMap(world, data) {
    ...
    map.append("g")
        ...
        .on('click', function (d, e) {
            ...
            //file path for data
            const HappinessUrl = "http://127.0.0.1:5000/data/facts/country/" + selectedCountry
            const HappinessCurrentYearUrl = "http://127.0.0.1:5000/data/facts/year/" + selectedYear + "/country/" + selectedCountry
            //open files
            Promise.all([
                d3.csv(HappinessUrl),
